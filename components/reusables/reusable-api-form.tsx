...
import GoBack, { GoBackProps } from "@/components/reusables/go-back";
import { TitleCaptionProps } from "@/components/reusables/title-caption";
...
export interface ReusableApiFormProps extends Omit<
  FormBuilderProps,
  "onSubmit"
> {
  title?: ReactNode;
