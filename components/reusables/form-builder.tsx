...
} from "@/components/reusables/input-currency-v1";
import InputDatev1, {
  InputDatev1Props,
} from "@/components/reusables/input-date-v1";
import InputPhone5, {
  InputPhone5Props,
} from "@/components/reusables/input-phone-5";
import InputSelectV1, {
  InputSelectV1Props,
} from "@/components/reusables/input-select-v1";
import InputV1, { InputV1Props } from "@/components/reusables/input-v1";
