    ...
    if (type === "email") {
      ...
      result = await supabase.auth.signInWithOtp({
        ...
        options: {
          ...
          // Email link (magic link) clicks go to /auth/confirm (server route).
          // /auth/confirm verifies token_hash server-side, sets session cookies,
          // then redirects to /auth/verifying for the success UI.
